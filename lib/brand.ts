export const BRAND = {
  ...
  description:
    "Anannt Education’s SAT feeder for PSAT/NMSQT and PSAT 10: two public lessons — slope in context and some-versus-all — then Digital SAT mentoring if you want a person. Not an AP course.",
  disclaimer:
...
export const METHOD_STEPS = [
  ...
  { title: "Test day", body: "Official digital practice stays outbound. Anannt never collects College Board credentials. After two lessons, Digital SAT mentoring is the only next human step." },
] as const

export const TRUST_POINTS = [
  {
    title: "College Board exam-prep authors, not a score mill",
    body: "Lessons are written to the digital PSAT suite: slope as rate versus start, and some versus all. We do not invent percentiles, and this path never upsells AP.",
  },
  {
