    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="text-sm leading-relaxed">
          <ol className="list-decimal space-y-2 pl-5">
            ...
            <li>Prepare for test day — official digital practice outbound, then a practical checklist.</li>
          </ol>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="text-sm leading-relaxed text-muted-foreground">
          It does not deliver the official exam or a scholarship, and it does not convert practice into an official score.
          It does not invent a 320–1520 from a percent correct. Official digital practice is an outbound task; Anannt never collects College Board credentials.
        </CardContent>
      </Card>
