            ...
            <label className="flex items-start gap-3 rounded-lg border p-3">
              ...
              <span>
                ...
                <span className="block text-sm text-muted-foreground">
                  Official scale 320–1520 (sections 160–760). SAT feeder only — not an AP path.
                </span>
              </span>
            </label>
            <label className="flex items-start gap-3 rounded-lg border p-3">
              ...
              <span>
                ...
                <span className="block text-sm text-muted-foreground">
                  Same score scale and shared core lessons. Distinct onboarding and reports. SAT habits only.
                </span>
              </span>
            </label>
          </RadioGroup>
