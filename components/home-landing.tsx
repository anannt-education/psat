...
import { PUBLIC_LESSONS, SAT_COACHING_URL, whatsappUrl } from "@/lib/mount"
    ...
    <div className="space-y-14">
      <section className="space-y-5">
        <p className="text-sm font-medium tracking-wide text-muted-foreground uppercase">
          {BRAND.name} · SAT feeder · not an AP course
        </p>
        <h1 className="max-w-3xl font-heading text-4xl font-semibold tracking-tight md:text-5xl">
          Two PSAT lessons. Then Digital SAT habits — never an AP upsell.
        </h1>
        <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
          {BRAND.tagline} Slope in context and some-versus-all are open with no account. After two
          honest lessons, a person in Burjuman can help with Digital SAT mentoring. This path does
          not sell AP.
        </p>
        <ContinueToPath />
      </section>
      ...
      <section aria-labelledby="search-intent" className="grid gap-4 md:grid-cols-3">
        ...
        <IntentCard
          title="PSAT/NMSQT"
          body="A preview of Digital SAT habits. Trademark language is in the footer. This desk does not claim scholarships."
          href={PUBLIC_LESSONS[0].path}
        />
        <IntentCard
          title="PSAT 10"
          body="Shared instructional core. Same two public lessons. After the gate, Digital SAT mentoring only."
          href={PUBLIC_LESSONS[1].path}
        />
        <IntentCard
          title="Digital SAT mentoring"
          body="If you want a human after two lessons, the next step is SAT coaching in Dubai — not an AP package."
      ...
      <section className="space-y-4" aria-labelledby="pilot-skills">
        <h2 id="pilot-skills" className="font-heading text-2xl font-semibold">
          Two public lessons you can open today
        </h2>
        <p className="max-w-2xl text-muted-foreground">
          Lesson 1 is slope in context. Lesson 2 is some versus all. Other units are not a public
          course on this host — they wait behind the study gate.
        </p>
      ...
      <section className="rounded-xl border bg-card p-6" aria-labelledby="families">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
          ...
          “some” is not “all.” Do not treat a practice percent as an official PSAT score. After two lessons,{" "}
          <a className="underline underline-offset-4" href={SAT_COACHING_URL}>
            Digital SAT mentoring
          </a>{" "}
          or{" "}
          <a className="underline underline-offset-4" href={whatsappUrl("sat-mentoring")}>
            WhatsApp Burjuman
          </a>
          .
        </p>
