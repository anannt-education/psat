...
10. Use Help for accessibility and outbound [Bluebook practice](https://bluebook.collegeboard.org/students/practice). Anannt does not counsel National Merit. Mentoring CTAs go to Digital SAT only (`https://anannt.ae/sat-coaching-dubai`).
...
- Does not guarantee scores, scholarships, or National Merit eligibility. Mentoring continues on Digital SAT, never AP subjects.
...
The dev server binds to `0.0.0.0:43133` with `basePath` `/psat`.
